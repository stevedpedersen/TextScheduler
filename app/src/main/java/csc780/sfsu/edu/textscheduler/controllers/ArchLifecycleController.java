...
public class ArchLifecycleController extends LifecycleController {
    ...
    @OnClick(R.id.btn_next_release_view) void onNextWithReleaseClicked() {
        ...
        getRouter().pushController(RouterTransaction.with(new NewTextController("Logcat should now report that the Controller's onDetach() and LifecycleObserver's onPause() methods were called, followed by the Controller's onDestroyView() and LifecycleObserver's onStop()."))
    ...
    @OnClick(R.id.btn_next_retain_view) void onNextWithRetainClicked() {
        ...
        getRouter().pushController(RouterTransaction.with(new NewTextController("Logcat should now report that the Controller's onDetach() and LifecycleObserver's onPause() methods were called."))
                .pushChangeHandler(new HorizontalChangeHandler())
                .popChangeHandler(new HorizontalChangeHandler()));
    }
